  ...
  <nav class="menu flex">
    ...
    <span class="menu__item searchLink flex">
      <a class="flex" href="/search?lang=lang" rel="noreferrer">
        ...
        <p class="menu__item__legend hide">sidebar.search</p>
      </a>
    </span>
    ...
    <span class="menu__item accountLink flex">
      ...
      <p class="menu__item__legend hide">sidebar.account</p>
    </span>
    <!-- <% } %>
      <% if (user.type !== 'guest') { %> -->
    <span class="menu__item exportsLink flex">
      ...
      <p class="menu__item__legend hide">sidebar.export</p>
    </span>
    <!-- <% } %>
      <% if (user.type === 'admin') { %> -->
    <span class="menu__item importLink flex">
      ...
      <p class="menu__item__legend hide">sidebar.import_users</p>
    </span>
    <span class="menu__item usersLink flex">
      ...
      <p class="menu__item__legend hide">sidebar.manage_users</p>
    </span>
    <span class="menu__item locationsLink flex">
      ...
      <p class="menu__item__legend hide">sidebar.manage_locations</p>
    </span>
    <span class="menu__item settingsLink flex">
      ...
      <p class="menu__item__legend hide">settings.title</p>
    </span>
    <!-- <% } %>
      <% } else { %> -->
    <span class="menu__item homeLink flex">
      <a class="flex" href="/?lang=lang" rel="noreferrer">
        ...
        <p class="menu__item__legend hide">sidebar.home</p>
      </a>
    </span>
    <!-- <% } %> -->
    <span class="menu__item aboutLink flex">
      ...
      <p class="menu__item__legend hide">sidebar.about</p>
    </span>
    <span class="menu__item logoutLink flex">
      <form class="logoutLink__form flex" action="/logout?_method=DELETE" method="post">
        ...
        <button class="menu__item__legend btn hide" type="submit">sidebar.log_out</button>
      </form>
    </span>
    <label class="lang flex">
      ...
      <span class="lang__container flex">
        <a href="/?lang=fr-BE"><svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 36 36">
        ...
        <a href="/?lang=en"><svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 36 36">
